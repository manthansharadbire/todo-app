...
const BADGE_CLASSES = {
    ...
    Medium:"border-2  border-yellow-400",
    Low:"border  border-red-700",
}
function TodoCard({task, priority}) {
  return (
    <div className={`relative bg-gray-200 m-5 border border-gray-400 rounded-lg shadow-lg py-4 pl-7
    ${TASK_PRIORITY_CLASSES [priority]}`}>
    <h1 className='text-2xl'>{task}</h1>
    <p className={` absolute top-5 right-11 rounded-lg border border-gray-400 block w-[100px] text-center
